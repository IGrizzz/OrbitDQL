...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 1, pixels * 4, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        ...
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 3, pixels * 1, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 7, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        self.agent = self.canvas_widget.create_image(pixels * 7, 0, anchor='nw', image=self.robot)
